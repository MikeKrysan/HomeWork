...
class HomeFragment : Fragment() {
    ...
    val filmsDataBase = listOf(
        Film("Friends", R.drawable.friends_cd66, "Злоключения группы друзей, преодолевающих ловушки работы, жизни и любви на Манхэттене.", 9.8f),
        ...
        Film("Jungle-cruise", R.drawable.jungle_cruise, "Доктор Лили Хоутон обращается за помощью к остроумному шкиперу Фрэнку Вольфу, чтобы тот отвез ее вниз по Амазонке на своей ветхой лодке. Вместе они ищут древнее дерево, обладающее исцеляющей силой, — открытие, которое изменит будущее медицины.", 6.9f),
        Film("Jurassic world dominion", R.drawable.jurassic_world_dominion, "Сюжет неизвестен.", 5.1f),
        Film("Shindlers list", R.drawable.schindlers_list, "Реальная история о том, как бизнесмен Оскар Шиндлер спас от нацистов более тысячи еврейских жизней, пока они работали рабами на его фабрике во время Второй мировой войны.", 8.2f),
        Film("Stranger things", R.drawable.stranger_things, "Когда пропадает мальчик, в маленьком городке раскрывается тайна, связанная с секретными экспериментами, ужасающими сверхъестественными силами и одной странной маленькой девочкой.", 3.7f),
        Film("The batman", R.drawable.the_batman, "На втором году борьбы с преступностью миллиардер Брюс Уэйн, также известный как Бэтмен, берет на себя таинственного серийного убийцу, известного как Загадочник.", 5.9f),
        Film("The lord of the rings", R.drawable.the_lord_of_the_rings, "Молодой хоббит Фродо Бэггинс, унаследовавший от своего дяди Бильбо таинственное кольцо, должен покинуть свой дом, чтобы оно не попало в руки злого создателя. Попутно создается товарищество, чтобы защитить хранителя кольца и убедиться, что кольцо прибыло в конечный пункт назначения: Роковая гора, единственное место, где его можно уничтожить.", 9.2f),
        Film("Toy story 4", R.drawable.toy_story_4, "Вуди всегда был уверен в своем месте в мире и в том, что его приоритетом является забота о своем ребенке, будь то Энди или Бонни. Но когда Бонни с неохотой добавляет в свою комнату новую игрушку по имени Форки, путешествие вместе со старыми и новыми друзьями покажет Вуди, насколько большим может быть мир для игрушки.", 7.0f),
        Film("The lion king", R.drawable.the_lion_king, "Молодой принц-лев изгнан из своей гордыни своим жестоким дядей, который утверждает, что убил своего отца. Пока дядя правит железной лапой, принц растет за пределами Саванны, живя по философии: никаких забот до конца своих дней. Но когда прошлое начинает преследовать его, молодой принц должен решить свою судьбу: останется ли он изгоем или столкнется со своими демонами и станет тем, кем он должен быть?", 9.1f),
    )
